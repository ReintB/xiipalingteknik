  ...
  return (
    <div className="container py-12 max-w-4xl">
      <div className="flex flex-col items-center justify-center space-y-4 text-center mb-8">
        ...
        <p className="max-w-[700px] text-muted-foreground md:text-xl">Hubungi kami untuk informasi lebih lanjut.</p>
      </div>
      ...
      <div className="max-w-3xl mx-auto">
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <Input name="subject" value={form.subject} onChange={handleChange} placeholder="Subjek" required />
          ...
          {responseMessage && <p className="text-center text-sm mt-2">{responseMessage}</p>}
        </form>
